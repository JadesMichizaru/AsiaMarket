...
@extends('themes.shop.shared.slider')
@section('content')
    <!-- Popular -->
            ...
            <div class="row mt-5">
                <div class="col-lg-3 col-6">
                    <div class="card card-product card-body p-lg-4 p3">
                        <a href="{{ url('/products') }}"><img src="{{ asset('themes/shop/assets/img/shop_01.jpg') }}"
                        ...
                        <div class="detail d-flex justify-content-between align-items-center mt-4">
                            ...
                            <a href="{{ url('/products') }}" class="btn-cart"><i class="bx bx-cart-alt"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-6">
                    <div class="card card-product card-body p-lg-4 p3">
                        <a href="{{ url('/products') }}"><img src="{{ asset('themes/shop/assets/img/shop_02.jpg') }}"
                                alt="" class="img-fluid"></a>
                ...
                <div class="col-lg-3 col-6 mt-3 mt-lg-0">
                    <div class="card card-product card-body p-lg-4 p3">
                        <a href="{{ url('/products') }}"><img src="{{ asset('themes/shop/assets/img/shop_03.jpg') }}"
                                alt="" class="img-fluid"></a>
                ...
                <div class="col-lg-3 col-6 mt-3 mt-lg-0">
                    <div class="card card-product card-body p-lg-4 p3">
                        <a href="#"><img src="{{ asset('themes/shop/assets/img/shop_04.jpg') }}" alt=""
                                class="img-fluid"></a>
    ...
    <section class="latest">
        <div class="container">
            ...
            <div class="row mt-5">
                ...
                <div class="col-lg-3 col-6 mt-3 mt-lg-0">
                    <div class="card card-product card-body p-lg-4 p3">
                        <a href="{{ url('/products') }}"><img src="{{ asset('themes/shop/assets/img/shop_04.jpg') }}"
                                alt="" class="img-fluid"></a>
                        <h3 class="product-name mt-3">Product 4</h3>
                        <div class="rating">
                            <i class="bx bxs-star"></i>
